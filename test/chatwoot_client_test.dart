...
void main() {
  group("Chatwoot Client Test", () {
    ...
    setUp(() async {
      ...
      mockProviderContainer = ProviderContainer(overrides: [
        localStorageProvider.overrideWith((ref, param) => mockLocalStorage),
        chatwootRepositoryProvider.overrideWith((ref, param) => mockRepository)
      ]);
